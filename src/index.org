...
* GNU Privacy Guardとは？
  ...
  :END:
#+BEGIN_HTML
<blockquote style="border: 5px solid red; text-align: center">
GnuPG開発者のWerner Koch氏はフルタイムでGnuPGの開発に携わっていますが、経済的には<a href="http://www.propublica.org/article/the-worlds-email-encryption-software-relies-on-one-guy-who-is-going-broke">良好ではない</a>と報道されております。<br>
可能な方は<a href="https://www.gnupg.org/donate/index.html">寄付</a>をお願いいたします。
</blockquote>
#+END_HTML
